        ...
        <div class="modal-content">
            <form role="form" method="POST" action="<?= base_url('anuncio_c/remover_anuncio') ?>">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tem certeza que deseja remover o anuncio?</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="confirm-delete" class="btn btn-danger"><span class="fa fa-check"></span> Confirmar</button>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
